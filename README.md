...
Crowdmo is a web application that allows Venmo users to create crowdfunds. [Check out the project website here -- this is not the actual web application](https://mateosnorian.github.io/Crowdmo/)
